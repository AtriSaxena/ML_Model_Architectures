...
# def positional_embedding(max_length, embed_size, device):
#     pos = torch.arange(max_length, dtype=torch.float, device=device).reshape(1,-1,1)
#     dim = torch.arange(embed_size, dtype= torch.float, device= device).reshape(1,1,-1)
